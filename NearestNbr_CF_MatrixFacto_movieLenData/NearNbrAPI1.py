...
This is just another version of NearNbrAPI where I have created the data and userItemRatingMatrix inside
...
############################%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
'''
Here I have created the data and userItemRatingMatrix here itself and pass to the module as an argument
'''
...
import NearestNeighbor_CF1 as NearestNeighborCF
NearestNbrCF_model = NearestNeighborCF.NearestNeighbors(data = data,data_m=data_m,
                                                        userItemRatingMatrix=userItemRatingMatrix)
